    ...
    <nav style={{
      ...
      <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
        <Link to="/dashboard" style={{
          color: isActive('/dashboard') ? C.amber : C.textSec,
          fontSize: 10, textDecoration: 'none', letterSpacing: 1.5, fontWeight: 500,
          borderBottom: `1px solid ${isActive('/dashboard') ? C.amber : 'transparent'}`,
        }}>TERMINAL</Link>
        <Link to="/calculators" style={{
          color: isActive('/calculators') ? C.amber : C.textSec,
          fontSize: 10, textDecoration: 'none', letterSpacing: 1.5, fontWeight: 500,
          borderBottom: `1px solid ${isActive('/calculators') ? C.amber : 'transparent'}`,
        }}>CALC</Link>
        <a href="https://github.com/evans-0/finance" target="_blank" rel="noopener noreferrer"
          style={{ color: C.textSec, textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
          <GitHubIcon />
        </a>
      </div>
    </nav>
